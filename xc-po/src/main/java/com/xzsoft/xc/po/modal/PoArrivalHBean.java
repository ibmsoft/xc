...
/** 
 * @ClassName: PoArrivalHBean 
 * @Description: 到货单主表实体类
 * @author weicw 
 * @date 2016年11月28日 下午3:08:07 
 * 
 * 
 */
public class PoArrivalHBean {
	private String ARRIVAL_H_ID;
	private String ARRIVAL_H_CODE;
	private String ARRIVAL_H_NAME;
	...
	public String getARRIVAL_H_CODE() {
		return ARRIVAL_H_CODE;
	}
	public void setARRIVAL_H_CODE(String aRRIVAL_H_CODE) {
		ARRIVAL_H_CODE = aRRIVAL_H_CODE;
	}
	public String getARRIVAL_H_NAME() {
		return ARRIVAL_H_NAME;
	}
	public void setARRIVAL_H_NAME(String aRRIVAL_H_NAME) {
		ARRIVAL_H_NAME = aRRIVAL_H_NAME;
	}
