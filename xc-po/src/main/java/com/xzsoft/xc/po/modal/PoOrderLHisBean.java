...
/** 
 * @ClassName: PoOrderLLBean 
 * @Description: 采购订单明细历史表
 * @author weicw 
 * @date 2016年11月28日 下午5:20:55 
 * 
 * 
 */
public class PoOrderLHisBean {
	private String ORDER_L_HIS_ID;
	...
	public PoOrderLHisBean() {
		super();
	}
	
	public String getORDER_L_HIS_ID() {
		return ORDER_L_HIS_ID;
	}

	public void setORDER_L_HIS_ID(String oRDER_L_HIS_ID) {
		ORDER_L_HIS_ID = oRDER_L_HIS_ID;
	}
