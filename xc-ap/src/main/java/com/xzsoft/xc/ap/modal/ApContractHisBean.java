...
* 
*/
public class ApContractHisBean {
	private String AP_CONTRACT_HIS_ID;
	...
	public String getAP_CONTRACT_HIS_ID() {
		return AP_CONTRACT_HIS_ID;
	}
	public void setAP_CONTRACT_HIS_ID(String aP_CONTRACT_HIS_ID) {
		AP_CONTRACT_HIS_ID = aP_CONTRACT_HIS_ID;
	}
