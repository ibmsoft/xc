...
@Repository
public interface XCSheetCellMapper extends SheetCellMapper {
	 ...
	 * @throws Exception
	 */
	public List<SheetCell> getModalsheetFormatCellList(@Param(value="tabId")String tabId) throws Exception;
	/**
	 * 查询报表数据
	 * @param map
	 * @return
	 * @throws Exception
	 */
	public List<ReportCellFormula> loadDataValue(SheetTab bean) throws Exception;
