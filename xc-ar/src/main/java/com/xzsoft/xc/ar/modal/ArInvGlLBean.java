...
/**
 * 
  * @ClassName：ArInvGlLBean
  * @Description：应收单行表实体类
  * @author：任建建
  * @date：2016年7月6日 上午11:10:20
 */
public class ArInvGlLBean {
	...
	public String toString() {
		return "ArInvGlLBean [AR_INV_GL_L_ID=" + AR_INV_GL_L_ID
				+ ", AR_INV_GL_H_ID=" + AR_INV_GL_H_ID + ", L_AR_INV_GL_L_ID="
				+ L_AR_INV_GL_L_ID + ", L_AR_INV_GL_H_ID=" + L_AR_INV_GL_H_ID
				+ ", AR_SALE_TYPE_ID=" + AR_SALE_TYPE_ID + ", PRODUCT_ID="
				+ PRODUCT_ID + ", ACC_ID=" + ACC_ID + ", CCID=" + CCID
				+ ", BG_ITEM_ID=" + BG_ITEM_ID + ", PRICE=" + PRICE
				+ ", INV_PRICE=" + INV_PRICE + ", AMOUNT=" + AMOUNT
				+ ", INV_AMOUNT=" + INV_AMOUNT + ", TAX_AMT=" + TAX_AMT
				+ ", TAX=" + TAX + ", QTY=" + QTY + ", DIM_CODE=" + DIM_CODE
				+ ", DESCRIPTION=" + DESCRIPTION + ", CREATION_DATE="
				+ CREATION_DATE + ", CREATED_BY=" + CREATED_BY
				+ ", LAST_UPDATE_DATE=" + LAST_UPDATE_DATE
				+ ", LAST_UPDATED_BY=" + LAST_UPDATED_BY + "]";
	}
	public ArInvGlLBean(String aR_INV_GL_L_ID, String aR_INV_GL_H_ID,
			String l_AR_INV_GL_L_ID, String l_AR_INV_GL_H_ID,
			String aR_SALE_TYPE_ID, String pRODUCT_ID, String aCC_ID,
			String cCID, String bG_ITEM_ID, double pRICE, double iNV_PRICE,
