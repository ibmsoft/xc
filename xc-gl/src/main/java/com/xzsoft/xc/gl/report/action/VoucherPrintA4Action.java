...
public class VoucherPrintA4Action extends AbstractTableData {
	 // 列名数组，保存程序数据集所有列名  
	...
	public void fecthReportData(){
		...
		if(parameters!=null && parameters.length>0){
			...
			try {
				...
				List<VDataReport>  vList = reportAccountDetailService.printA4Report(map);
				//添加数据集的行
