...
/**
 * @fileName VoucherFineDataAction
 * @desc 凭证取数
 * @author tangxl
 * @date 2016年3月23日
 */
@SuppressWarnings("serial")
public class VoucherFineDataAction extends AbstractTableData {
	 // 列名数组，保存程序数据集所有列名  
	...
	private enum reportColumn {V_HEAD_ID,LEDGER_NAME,ORG_NAME,V_ATTCH_TOTAL,V_SERIAL_NUM,CREATION_DATE,
		...
		VERIFIER,SIGNATORY,BOOKKEEPER,AMOUNT,T_ACCOUNT_DR,T_ACCOUNT_CR,T_AMOUNT,ENTER_AMOUNT,T_ENTER_AMOUNT,EXCHANGE_RATE,FOREIGN_NAME,DIMENSION_NAME,V_CATEGORY_NAME};
    public VoucherFineDataAction() {
		//构造函数初始化报表参数
