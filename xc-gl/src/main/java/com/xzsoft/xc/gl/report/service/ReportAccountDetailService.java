package com.xzsoft.xc.gl.report.service;
 ...
 * 
 */
public interface ReportAccountDetailService {
	/**
	...
	/**
	 * 
	 * @title:  ReportAccountDetailService.java
	 * @desc:   现金流量报表取数接口
	 * @author  tangxl
	 * @date    2016年3月24日
	 * @param   map
	 ...
	 * @throws Exception 
	 */
	public List<VDataReport> printA4Report(HashMap<String, String> map) throws Exception;
	/**
	 * 
